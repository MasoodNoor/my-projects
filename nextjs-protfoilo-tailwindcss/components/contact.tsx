        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              ...
              <p className="leading-normal my-5 flex flex-col items-center space-x-2">
                <span className="text-xl font-semibold">Fiverr</span>
              </p>

              <p className="leading-normal my-5 flex justify-center items-center space-x-2">
                <svg
                  className="w-6 h-6 text-gray-800 dark:text-gray-500"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-xl font-semibold">Karachi, Pakistan</span>
              </p>
            </div>
          </div>
        </div>
