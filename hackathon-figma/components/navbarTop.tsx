...
function NavbarTop() {
  return (
    <div className="w-screen  md:h-[124px] bg-white sm:flex sm:items-center sm:justify-between">
      {/* logo and search  for mobile*/}
      <div className="sm:w-screen sm:flex  sm:items-center sm:gap-[64px]">
        <div className=" h-[28px] py-[32px] px-[25px] flex justify-between items-center sm:hidden">
        ...
        <div className="w-screen  flex justify-between gap-2 px-[32px] items-center sm:hidden">
          <button className="w-svw h-[48px]  sm:h-[44px] rounded-xl sm:rounded-[70px] border border-[#C3D4E966] bg-white flex justify-between items-center px-5 overflow-hidden">
            <div className="flex gap-6 pr-8">
              ...
              <p className="w-[150px] font-plusJakarta font-medium text-[14px] leading-[21px] tracking-[-0.02em] text-justify text-[#596780] overflow-hidden ">
          ...
          <div className="sm:hidden w-[48px] h-[48px] border inline-flex justify-center items-center border-[#C3D4E966] rounded-xl px-3">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        {/* for desktop logo search and notification */}
        <div className="sm:w-full sm:flex sm:items-center sm:justify-around sm:py-[32px] sm:px-[32px] ">
          <p className="sm:h-[28px]  md:w-[148px] md:h-[44px] sm:text-[24px] md:text-[32px] font-bold sm:leading-[36px] sm:py-[32px] md:leading-[48px] tracking-[-0.03em] text-left text-[#3563E9] font-plusJakarta hidden sm:flex sm:items-center">
            MORENT
          </p>
          <div className=" h-[48px] py-[32px] px-[22px] sm:w-screen sm:flex justify-between gap-4 sm:gap-6 items-center hidden">
            <button className="sm:w-[300px] md:w-[492px] sm:h-[44px] rounded-xl sm:rounded-[70px] border border-[#C3D4E966] bg-white flex justify-between items-center px-5">
              <div className="flex gap-6 pr-8">
                <svg
                  className="w-[24px] h-[24px] text-[#596780]"
                  viewBox="0 0 24 24"
          ...
          <div className="sm:w-[236px] sm:h-[44px] sm:flex sm:justify-end sm:gap-[10px] md:gap-[20px] hidden ">
            <button className="w-[44px] h-[44px] gap-0 rounded-[90px] border border-[#C3D4E966] opacity-[0.8] flex justify-center items-center sm:hidden md:flex">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <button className="w-[44px] h-[44px] rounded-[90px] border border-[#C3D4E966] opacity-[0.8] flex flex-col justify-center items-center sm:hidden md:flex">
