...
function NavbarTop() {
  return (
    <div className="w-full h-[124px] border-t border-[#C3D4E966] bg-white flex items-center justify-between px-[60px]  ">
          {/* logo and search */}
      ...
      <div className="w-[492px] h-[44px]">
        <button className="w-[492px] h-[44px] rounded-[70px] border border-[#C3D4E966] bg-white flex justify-between items-center px-5">
          <div className="flex gap-6">
            ...
            <p
              className={`${plusJakartaSans.className} font-medium text-[14px] leading-[21px] tracking-[-0.02em] text-justify text-[#596780]`}
            >
        ...
        <div className="w-[236px] h-[44px] flex gap-[20px]">
          ...
          <div className="w-[44px] h-[44px] gap-0 rounded-[90px] border border-[#C3D4E966] opacity-[0.8] flex justify-center items-center">
            <Image
