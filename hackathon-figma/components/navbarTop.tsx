...
function NavbarTop() {
  return (
    ...
    <div className="grid grid-cols-2 gap-3 items-center px-[24px]  py-8 md:py-[40px] md:grid-cols-[1fr_2fr_1fr] gap-y-7 w-full ">
      ...
      <div className="col-span-1 flex justify-end gap-5 order-2 md:order-3">
        ...
        <button className="w-[44px] h-[44px] rounded-[90px] border border-[#C3D4E966] opacity-[0.8]  flex-col justify-center items-center hidden lg:flex">
          <div className="w-[11px] h-[11px] rounded-full bg-[#FF4423] absolute top-11 ml-8"></div>
