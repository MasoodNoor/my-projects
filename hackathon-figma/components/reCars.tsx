...
const RecommandCar = ({
  ...
  return (
    <div className="bg-white rounded-[10px] shadow-md overflow-hidden p-4 sm:p-6 w-[327px] h-[240px] sm:w-[304px] sm:h-[388px]">
      ...
      <div className="grid grid-cols-[8fr_4fr] sm:grid-cols-1 gap-x-4 sm:gap-y-8 pb-10 pt-5  sm:pt-8 ">
        <div className="h-[70px] sm:h-[120px] flex items-end">
          <Image
        ...
        <div className="flex flex-col sm:flex-row justify-around sm:justify-between sm:items-center">
